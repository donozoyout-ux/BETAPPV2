    ...
    try {
      ...
      for (const item of analysis.items) {
        await client.query(`INSERT INTO odds_analysis_items(run_id,market_type,market_name,line,selection,opening_odds,
          ...
          probability_delta_pp,raw_odds_movement_percent,bookmaker_count,complete_state_bookmaker_count,
          minimum_complete_state_count,agreeing_bookmaker_count,
          ...
          $25::jsonb,$26,$27,$28,$29,$30,$31,$32::jsonb,$33::jsonb)`,
        [runId,item.marketType,item.marketName,item.line,item.selection,item.openingOdds,item.currentOdds,item.highestOdds,
          ...
          item.rawOddsMovementPercent,item.bookmakerCount,item.completeStateBookmakerCount,item.minimumCompleteStateCount,
          item.agreeingBookmakerCount,item.disagreeingBookmakerCount,
