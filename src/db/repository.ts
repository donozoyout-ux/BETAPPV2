...
export class FootballRepository {
  ...
  async databaseHealth() {
    ...
    requiredTables.push('prediction_model_versions','prediction_runs','prediction_historical_examples','prediction_journal','prediction_settlements');
    ...
    requiredIndexes.push('prediction_runs_match_created_idx','prediction_historical_examples_lookup_idx',
