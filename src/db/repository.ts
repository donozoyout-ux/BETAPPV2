...
export class FootballRepository {
  ...
  async databaseHealth() {
    ...
    requiredTables.push('prediction_model_versions','prediction_runs','prediction_historical_examples','prediction_historical_refreshes','prediction_journal','prediction_settlements','prediction_self_audits','prediction_self_audit_segments');
