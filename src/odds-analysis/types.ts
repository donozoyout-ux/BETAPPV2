...
export type BookmakerSelectionMovement = {
  ...
  minimumMarketSelectionSnapshotCount: number;
  completeStateCount: number;
  openingCompleteAt: Date;
  currentCompleteAt: Date;
  hasDistinctCompleteStates: boolean;
...
export type ConsensusResult = {
  ...
  completeStateBookmakerCount: number;
